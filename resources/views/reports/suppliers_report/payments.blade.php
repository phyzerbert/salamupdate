...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="pull-left page-title"><i class="fa fa-credit-card"></i> {{__('page.supplier_payments')}}</h3>
                ...
                <div class="">
                    <ul class="nav nav-tabs tabs" role="tablist" style="width: 100%;border:none">
                        <li class="nav-item tab" style="width: 100px;">
                            <a class="nav-link" id="home-tab-2" data-toggle="tab" href="{{route('report.suppliers_report.purchases', $supplier->id)}}" role="tab" aria-controls="home-2" aria-selected="false">
                                <span class="d-block d-sm-none"><i class="fa fa-sign-out"></i></span>
                                <span class="d-none d-sm-block">{{__('page.purchases')}}</span>
                            </a>
                        </li>
                        <li class="nav-item tab" style="width: 100px;">
                            <a class="nav-link active" id="profile-tab-2" data-toggle="tab" href="{{route('report.suppliers_report.payments', $supplier->id)}}" role="tab" aria-controls="profile-2" aria-selected="true">
                                <span class="d-block d-sm-none"><i class="fa fa-credit-card"></i></span>
                                <span class="d-none d-sm-block">{{__('page.payments')}}</span>
                            </a>
                        </li>
                        <div class="indicator" style="left: 110px;width:110px;"></div>
                    </ul>
                </div>
                <div class="mt-2">
