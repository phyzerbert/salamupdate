...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="pull-left page-title"><i class="fa fa-sign-out"></i> {{__('page.user_sales')}}</h3>
                    <ol class="breadcrumb pull-right">
                        ...
                        <li class="active">{{__('page.sales')}}</li>
                    </ol>
                </div>
            </div>        
            @php
                ...
                <div class="">
                    <ul class="nav nav-tabs tabs" role="tablist" style="width: 100%;border:none">
                        <li class="nav-item tab" style="width: 100px;">
                            <a class="nav-link" id="home-tab-2" data-toggle="tab" href="{{route('report.users_report.purchases', $user->id)}}" role="tab" aria-controls="" aria-selected="false">
                                <span class="d-block d-sm-none"><i class="fa fa-sign-out"></i></span>
                                <span class="d-none d-sm-block">{{__('page.purchases')}}</span>
                            </a>
                        </li>                        
                        <li class="nav-item tab" style="width: 100px;">
                            <a class="nav-link active" id="home-tab-2" data-toggle="tab" href="{{route('report.users_report.sales', $user->id)}}" role="tab" aria-controls="" aria-selected="true">
                                <span class="d-block d-sm-none"><i class="fa fa-sign-out"></i></span>
                        ...
                        <div class="indicator" style="left: 110px;width:90px;"></div>
                    </ul>
                </div>
                <div class="mt-2">
