...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="pull-left page-title"><i class="fa fa-bar-chart"></i> {{__('page.store_chart')}}</h3>
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{route('home')}}">{{__('page.home')}}</a></li>
                        <li><a href="{{route('report.overview_chart')}}">{{__('page.reports')}}</a></li>
                        <li class="active">{{__('page.store_chart')}}</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <form action="" class="form-inline mx-auto" method="post">
                            ...
                            <button type="button" class="btn btn-sm btn-warning ml-2" id="btn-reset"> <i class="fa fa-eraser"></i> {{__('page.reset')}}</button>
                        </form>
                    </div>
                </div>
                <div class="row">
