...
@section('content')
    <div class="content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="pull-left page-title"><i class="fa fa-sitemap"></i> {{__('page.category_management')}}</h3>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="py-1">
                                        ...
                                        <a href="{{route('category.delete', $item->id)}}" class="btn btn-sm btn-danger btn-icon" data-id="{{$item->id}}" onclick="return window.confirm('{{__('page.are_you_sure')}}')"><div><i class="fa fa-trash-o"></i></div></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
