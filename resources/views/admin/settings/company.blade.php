                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="py-1">
                                        ...
                                        <a href="{{route('company.delete', $item->id)}}" class="btn btn-sm btn-danger btn-icon" data-id="{{$item->id}}" onclick="return window.confirm('{{__('page.are_you_sure')}}')"><div><i class="fa fa-trash-o"></i></div></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
